...
// adding staf
router.post("/administration/registerStaff",contextMidlleware(true),validateAjv(administrationSchema), AuthMiddleware,CheckPermission("staff_management","create"),administrationController.addStaff)
// staff login
router.post("/administration/login",validateAjv(administrationSchema),AdministrationController.loginStaff)
